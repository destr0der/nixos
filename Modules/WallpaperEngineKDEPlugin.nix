# Credit: 
# https://github.com/xerhaxs/nixos/blob/b65a73670f6d7be11cbbaa866a5456eb81689983/nixosModules/pkgs/wallpaper-engine-kde-plugin.nix#L23
  ...
  config = lib.mkIf (config.nixos.pkgs.wallpaper-engine-kde-plugin.enable && config.services.desktopManager.plasma6.enable) {
    ...
    system.activationScripts = {
      wallpaper-engine-kde-plugin.text = ''
        ...
        chmod -R 0744 /home/callum/.local/share/plasma
